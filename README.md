...
The [Auto builds](https://github.com/USTC-vlab/labstrap/releases/tag/auto-build-debian13) release holds VM images built on GitHub Actions.
...
```shell
docker build -t labstrap:debian13 .
```
